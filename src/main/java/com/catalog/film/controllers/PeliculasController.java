package com.catalog.film.controllers;
...
import com.catalog.film.services.IActorService;
import com.catalog.film.services.IArchivoService;
import com.catalog.film.services.IGeneroService;
import com.catalog.film.services.IPeliculaService;
...
public class PeliculasController {
	...
	public String eliminar(@PathVariable(name = "id") Long id, Model model, RedirectAttributes redirectAtt) {
		...
		redirectAtt.addFlashAttribute("msj", "La pelicula fue eliminada correctamente");
